...
namespace Portal.Core
{
    public class ActivityCalenderBL
    {
        ...
        public List<ActivityCalenderViewModel> GetActivityCalenderList( int calenderId, string fromDate, string toDate, string Status)
        {
            List<ActivityCalenderViewModel> activityCalenders = new List<ActivityCalenderViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtactivityCalenders = sqlDbInterface.GetActivityCalenderList( calenderId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), Status);
