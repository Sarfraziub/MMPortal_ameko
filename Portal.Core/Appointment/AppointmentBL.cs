...
namespace Portal.Core
{
    ...
    public class AppointmentBL
    {
        ...
        public List<AppointmentViewModel> GetAppointmentList(string appointLetterNo, string interviewNo, string applicantName, string appointStatus, int companyId, string fromDate, string toDate)
        {
            ...
            try
            {
                DataTable dtAppointments = hrsqlDbInterface.GetAppointmentList(appointLetterNo, interviewNo, applicantName, appointStatus, companyId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate));
