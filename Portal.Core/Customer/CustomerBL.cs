...
namespace Portal.Core
{
    public class CustomerBL
    {
        ...
        public ResponseOut AddEditCustomerBranchMaster(int customerId, CustomerBranchViewModel customerBranchViewModel)
        {
            ResponseOut responseOutBranch = new ResponseOut();
            using (TransactionScope transactionscope = new TransactionScope())
            {
                try
                {
                    ...
                    responseOutBranch = dbInterface.AddEditCustomerBranchMaster(customerBranch);
                    transactionscope.Complete();
                }
                catch (TransactionException ex1)
                {
                    transactionscope.Dispose();
                    responseOutBranch.status = ActionStatus.Fail;
                    responseOutBranch.message = ActionMessage.ApplicationException;
                    Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex1);
                    throw ex1;
                }
                catch (Exception ex)
        ...
        public List<CustomerViewModel> GetCustomerAutoCompleteList(string searchTerm, int companyId)
        {
            ...
            try
            {
                ...
                if (customerList != null && customerList.Count > 0)
                {
                    ...
                    {
                        customers.Add(new CustomerViewModel { CustomerId = customer.CustomerId, CustomerName = customer.CustomerName, CustomerCode = customer.CustomerCode, PrimaryAddress = customer.PrimaryAddress, GSTNo = customer.GSTNo });
                    }
                }
            }
            catch (Exception ex)
        ...
        public List<CustomerBranchViewModel> GetCustomerBranches(int customerId)
        {
            ...
            try
            {
                ...
                if (customerList != null && customerList.Count > 0)
                {
                    ...
                    {
                        customers.Add(new CustomerBranchViewModel { CustomerBranchId = customer.CustomerBranchId, BranchName = customer.BranchName, GSTNo = customer.GSTNo });
                    }
                }
            }
            catch (Exception ex)
        ...
        public List<CustomerBranchViewModel> GetCustomerBranchListWithOutCustId()
        {
            List<CustomerBranchViewModel> customers = new List<CustomerBranchViewModel>();
            try
            {
                List<CustomerBranch> customerList = dbInterface.GetCustomerBranchListWithOutCustId();
            ...
            try
            {
                ...
                if (customerList != null)
                {
                    customers = new CustomerBranchViewModel
                    {
                        ...
                        BranchName = customerList.BranchName,
                        CustomerBranchId = customerList.CustomerBranchId,
        ...
        public DataTable GetCustomerSiteWiseReport(int customerId, int customerBranchId)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            DataTable dtCustomerSiteWiseModel = new DataTable();
            try
            {
                dtCustomerSiteWiseModel = sqlDbInterface.GetCustomerSiteWiseReport(customerId, customerBranchId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
            ...
            return dtCustomerSiteWiseModel;
        }
