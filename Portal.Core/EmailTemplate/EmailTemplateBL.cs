...
namespace Portal.Core
{
    public class EmailTemplateBL
    {
        ...
        public List<EmailTemplateViewModel> GetEmailTemplateList(string emailTemplateSubject="", int emailTemplateTypeId=0, int companyId=0, string status="")
        {
            List<EmailTemplateViewModel> emailTemplates = new List<EmailTemplateViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtEmailTemplates = sqlDbInterface.GetEmailTemplateList(emailTemplateSubject, emailTemplateTypeId, companyId, status);
