...
namespace Portal.Core
{
    public class EmployeeAdvanceAppBL
    {
        ...
        public List<HR_EmployeeAdvanceApplicationViewModel> GetEmployeeAdvanceAppList(string applicationNo, int employeeId , string advanceTypeId ,  string advanceStatus, string fromDate, string toDate, int companyId)
        {
            List<HR_EmployeeAdvanceApplicationViewModel> employeeadvanceApplications = new List<HR_EmployeeAdvanceApplicationViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtEmployeeAdvanceApplications = sqlDbInterface.GetEmployeeAdvanceAppList(applicationNo, employeeId, advanceTypeId, advanceStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId);
