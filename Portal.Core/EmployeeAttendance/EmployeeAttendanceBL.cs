...
namespace Portal.Core
{
    public class EmployeeAttendanceBL
    {
        ...
        public ResponseOut AddEditEmployeeAttendance(int companyId, int employeeId, string attendanceDate, string presentAbsent, string inTime, string outTime, string attendanceStatus, int userId)
        {
            ...
            try
            {
                responseOut = sqlDbInterface.AddEditEmployeeAttendance(companyId, employeeId, attendanceDate, presentAbsent, inTime, outTime, attendanceStatus, userId);
            }
            catch (Exception ex)
            {
        ...
        public List<HR_EmployeeAttendanceViewModel> GetEmployeeMarkAttendanceList(int employeeId, string attendanceDate, int departmentId, int designationId)
        {
            List<HR_EmployeeAttendanceViewModel> employeeAttendance = new List<HR_EmployeeAttendanceViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtEmployeeAttendance = sqlDbInterface.GetEmployeeAttendanceList(employeeId, attendanceDate, departmentId, designationId);
        ...
        public DataTable GetEmployeeAttendanceReport(int month, int year, int roleId)
        {
            ...
            try
            {
                dtEmployeeAttendance = hRSQLDBInterface.GetEmployeeAttendanceReport(month, year,roleId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
