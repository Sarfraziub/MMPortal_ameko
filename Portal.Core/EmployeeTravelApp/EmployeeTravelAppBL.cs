...
namespace Portal.Core
{
    public class EmployeeTravelAppBL
    {
        ...
        public List<HR_EmployeeTravelApplicationViewModel> GetEmployeeTravelAppList(string applicationNo, int employeeId , string travelTypeId,  string travelStatus, string travelDestination,string fromDate, string toDate, int companyId)
        {
            List<HR_EmployeeTravelApplicationViewModel> employeetravelApplications = new List<HR_EmployeeTravelApplicationViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtEmployeeTravelApplications = sqlDbInterface.GetEmployeeTravelAppList(applicationNo, employeeId, travelTypeId, travelStatus, travelDestination, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId);
