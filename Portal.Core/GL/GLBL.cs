...
namespace Portal.Core
{
    public class GLBL
    {
        ...
        public List<GLViewModel> GetGLList(string GLHead = "", string GLCode = "", string GLType = "", int GLMainGroupId = 0, int GLSubGroupId = 0, int SLTypeId = 0, int companyId = 0,int finYear=0)
        {
            List<GLViewModel> gls = new List<GLViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtGLs = sqlDbInterface.GetGLList(GLHead,GLCode, GLType,GLMainGroupId,GLSubGroupId,SLTypeId,companyId, finYear);
