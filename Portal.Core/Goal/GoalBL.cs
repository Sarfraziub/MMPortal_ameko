...
namespace Portal.Core
{
    public class GoalBL
    {
        ...
        public List<PMSGoalViewModel> GetGoalList(string goalName, int sectionId, int goalCategoryId, int performanceCycleId, string goalStatus, string fromDate, string toDate, int companyId)
        {
            List<PMSGoalViewModel> pMSGoalViewModel = new List<PMSGoalViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtPMSGoal = sqlDbInterface.GetGoalList(goalName, sectionId, goalCategoryId, performanceCycleId, goalStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId);
