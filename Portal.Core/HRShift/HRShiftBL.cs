...
namespace Portal.Core
{
    public class HRShiftBL
    {
        ...
        public List<ShiftViewModel> GetShiftList(string shiftName ="",int shiftTypeId = 0, string Status = "",int companyId=0)
        {
            List<ShiftViewModel> shiftViewModel = new List<ShiftViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dteducation = sqlDbInterface.GetShiftList(shiftName,shiftTypeId, Status, companyId);
