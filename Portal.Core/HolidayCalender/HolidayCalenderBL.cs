...
namespace Portal.Core
{
    public class HolidayCalenderBL
    {
        ...
        public List<HolidayCalenderViewModel> GetHolidayCalenderList(int calenderId, int holidaytypeId, string fromDate, string toDate, string Status)
        {
            List<HolidayCalenderViewModel> holidayCalenders = new List<HolidayCalenderViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtholidayCalenders = sqlDbInterface.GetHolidayCalenderList(calenderId, holidaytypeId,Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), Status);
