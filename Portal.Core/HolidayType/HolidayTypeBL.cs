...
namespace Portal.Core
{
    public class HolidayTypeBL
    {
        ...
        public List<HolidayTypeViewModel> GetHolidayTypeList(string holidaytypeName = "", string Status = "")
        {
            List<HolidayTypeViewModel> holidaytypes = new List<HolidayTypeViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtHolidayTypes = sqlDbInterface.GetHolidayTypeList(holidaytypeName, Status);
        ...
        public List<HolidayTypeViewModel> GetHolidayTypeIdList()
        {
            List<HolidayTypeViewModel> holidaytypes = new List<HolidayTypeViewModel>();
            try
            {
                List<HR_HolidayType> holidaytypeList = dbInterface.GetHolidayTypeIdList();
