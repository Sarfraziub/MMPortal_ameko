  ...
  public class InterviewBL
    {
        ...
        public List<InterviewViewModel> GetInterviewList(string interviewNo, string applicantNo, string interviewFinalStatus, int companyId, string fromDate, string toDate)
        {
            List<InterviewViewModel> interviews = new List<InterviewViewModel>();
            HRSQLDBInterface hrsqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtInterviews = hrsqlDbInterface.GetInterviewList(interviewNo, applicantNo, interviewFinalStatus, companyId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate) );
