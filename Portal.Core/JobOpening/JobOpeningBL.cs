...
namespace Portal.Core
{
    public class JobOpeningBL
    {
        ...
        public List<JobOpeningViewModel> GetJobOpeningList(string jobOpeningNo = "", string requisitionNo = "", string jobPortalRefNo = "", string jobTitle="", string fromDate = "", string toDate = "", int companyId=0,string jobStatus="Final")
        {
            List<JobOpeningViewModel> jobOpenings = new List<JobOpeningViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtJobOpenings = sqlDbInterface.GetJobOpeningList(jobOpeningNo,requisitionNo, jobPortalRefNo, jobTitle, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId,jobStatus);
