...
namespace Portal.Core
{
    public class PMS_AppraisalTemplateBL
    {
        ...
        public List<PMS_AppraisalTemplateViewModel> GetAppraisalTemplateLists(string templateName, int department, int designation, int companyId,string appraisaltemplateStatus)
        {
            List<PMS_AppraisalTemplateViewModel> appraisaltemplates = new List<PMS_AppraisalTemplateViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtQuotations = sqlDbInterface.GetAppraisalTemplateLists(templateName, department, designation,  companyId, appraisaltemplateStatus);
