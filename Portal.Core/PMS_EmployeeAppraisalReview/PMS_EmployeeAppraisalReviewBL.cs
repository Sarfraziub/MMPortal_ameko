...
namespace Portal.Core
{
    public class PMS_EmployeeAppraisalReviewBL
    {
        ...
        public List<PMS_EmployeeAppraisalReviewViewModel> GetEmployeeAppraisalReviewList(string employeeName, string pmsFinalStatus, int companyId)
        {
            List<PMS_EmployeeAppraisalReviewViewModel> empReviews = new List<PMS_EmployeeAppraisalReviewViewModel>();
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            try
            {
                DataTable dtQuotations = sqlDbInterface.GetEmployeeAppraisalReviewList(employeeName,pmsFinalStatus,companyId);
