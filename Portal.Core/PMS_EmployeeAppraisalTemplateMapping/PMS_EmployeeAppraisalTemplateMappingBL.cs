...
namespace Portal.Core
{
    public class PMS_EmployeeAppraisalTemplateMappingBL
    {
        ...
        public List<PMS_EmployeeAppraisalTemplateMappingViewModel> GetEmployeeAppraisalTemplateMappingList(string templateName, string employeeName, int companyId,string employeeMapping_Status)
        {
            ...
            try
            {
                DataTable dtQuotations = sqlDbInterface.GetEmployeeAppraisalTemplateMappingLists(templateName,employeeName,companyId, employeeMapping_Status);
