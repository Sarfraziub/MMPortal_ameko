...
namespace Portal.Core
{
    public class PayHeadGLMappingBL
    {
        ...
        public List<PayHeadGLMappingViewModel> GetPayHeadGLMappingList(string payHeadName = "", int companyId = 0, string status = "")
        {
            ...
            try
            {
                DataTable dtTaxes = sqlDbInterface.GetPayHeadGLMappingList(payHeadName, companyId, status);
