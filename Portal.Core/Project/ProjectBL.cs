  ...
  public  class ProjectBL
    {
        ...
        public List<ProjectViewModel> GetProjectList(string projectName = "",int projectCode = 0,int customerId = 0 , int customerBranchId=0,string projectStatus="")
        {
            ...
            try
            {
                ...
                DataTable dtProjects = sqlDbInterface.GetProjectList(projectName, projectCode, customerId, customerBranchId, projectStatus);
