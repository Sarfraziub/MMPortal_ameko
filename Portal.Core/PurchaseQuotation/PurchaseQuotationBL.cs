...
namespace Portal.Core
{
    public class PurchaseQuotationBL
    {
        ...
        public List<PurchaseQuotationViewModel> GetPurchaseQuotationList(string quotationNo, string vendorName, string refNo, string fromDate, string toDate, int companyId, string displayType = "",string approvalStatus="")
        {
            List<PurchaseQuotationViewModel> quotations = new List<PurchaseQuotationViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtQuotations = sqlDbInterface.GetPurchaseQuotationList(quotationNo, vendorName, refNo, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate),companyId, displayType, approvalStatus);
        ...
        public List<PurchaseIndentViewModel> GetPurchaseQuotationIndentList(string indentNo, string indentType, string customerName, int companyBranchId, DateTime fromDate, DateTime toDate, int companyId, string displayType = "", string approvalStatus = "0")
        {
            List<PurchaseIndentViewModel> indents = new List<PurchaseIndentViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtIndents = sqlDbInterface.GetPurchaseQuotationIndentList(indentNo, indentType, customerName, companyBranchId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId, displayType, approvalStatus);
        ...
        public List<PurchaseIndentProductDetailViewModel> GetPurchaseQuotationIndentProductList(long indentId)
        {
            List<PurchaseIndentProductDetailViewModel> indentProducts = new List<PurchaseIndentProductDetailViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtIndentProducts = sqlDbInterface.GetPurchaseQuotationIndentProductList(indentId);
