...
namespace Portal.Core
{
    public class PurchaseReturnBL
    {
        ...
        public List<PurchaseReturnViewModel> GetPurchaseReturnList(string purchaseReturnNo, string vendorName, string dispatchrefNo, string fromDate, string toDate, string approvalStatus, int companyId)
        {
            List<PurchaseReturnViewModel> purchaseReturnViewModel = new List<PurchaseReturnViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtDeliveryChallans = sqlDbInterface.GetPurchaseReturnList(purchaseReturnNo, vendorName, dispatchrefNo, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), approvalStatus, companyId);
