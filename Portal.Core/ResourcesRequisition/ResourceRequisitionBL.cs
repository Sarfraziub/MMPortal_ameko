...
namespace Portal.Core
{
    public class ResourceRequisitionBL
    {
        ...
        public List<ResourceRequisitionViewModel> GetResourceRequisitionList(string requisitionNo, int positionLevelId, string priorityLevel, int positionTypeId, int departmentId, string approvalStatus, string fromDate, string toDate, int companyId)
        {
            List<ResourceRequisitionViewModel> requisitions = new List<ResourceRequisitionViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtRequisitions = sqlDbInterface.GetResourceRequisitionList(requisitionNo, positionLevelId, priorityLevel,  positionTypeId, departmentId, approvalStatus, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate), companyId);
