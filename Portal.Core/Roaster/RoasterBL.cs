...
namespace Portal.Core
{
    public class RoasterBL
    {
        ...
        public List<HR_RoasterViewModel> GetRoasterList(string roasterName = "", string fromDate="", string toDate="", string roasterType = "", int department = 0,int companyId = 0, string Status = "")
        {
            List<HR_RoasterViewModel> roasters = new List<HR_RoasterViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtRoasters = sqlDbInterface.GetRoasterList(roasterName, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), roasterType, department, companyId, Status);
        ...
        public ResponseOut UpdateEmployeeRosterShift(int rosterId, int shiftId, string startDate, string endDate, int createdBy, List<HR_EmployeeRosterViewModel> employeeRosters)
        {
            HRSQLDBInterface sqlDbInterface = new HRSQLDBInterface();
            ResponseOut responseOut = new ResponseOut();
            try
            {
                ...
                responseOut = sqlDbInterface.UpdateEmployeeRosterShift(rosterId,shiftId,Convert.ToDateTime(startDate),Convert.ToDateTime(endDate),createdBy,employeeRosterList);
            }
            catch (Exception ex)
            {
                responseOut.status = ActionStatus.Fail;
