  ...
  public class STNBL
    {
        ...
        public ResponseOut AddEditSTN(STNViewModel stnViewModel, List<STNProductDetailViewModel> stnProducts,List<STNSupportingDocumentViewModel> stnDocuments)
        {
            ...
            try
            {
                ...
                responseOut = sqlDbInterface.AddEditSTN(stn, stnProductList, stnDocumentList);
