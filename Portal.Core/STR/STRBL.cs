  ...
  public class STRBL
    {
        ...
        public ResponseOut AddEditSTR(STRViewModel strViewModel, List<STRProductDetailViewModel> strProducts,List<STRSupportingDocumentViewModel> strDocuments)
        {
            ...
            try
            {
                ...
                responseOut = sqlDbInterface.AddEditSTR(str, strProductList, strDocumentList);
