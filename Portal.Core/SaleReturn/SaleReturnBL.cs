...
namespace Portal.Core
{
    public class SaleReturnBL
    {
        ...
        public ResponseOut AddEditSaleReturn(SaleReturnViewModel saleReturnViewModel, List<SaleReturnProductViewModel> saleReturnProducts)
        {
            ...
            try
            {
                ...
                responseOut = sqlDbInterface.AddEditSaleReturn(saleReturn, saleReturnProductList); 
        ...
        public List<SaleReturnViewModel> GetSaleReturnList(string saleReturnNo, string customerName, string dispatchrefNo, string fromDate, string toDate, string approvalStatus, int companyId)
        {
            List<SaleReturnViewModel> saleReturnViewModel = new List<SaleReturnViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtDeliveryChallans = sqlDbInterface.GetSaleReturnList(saleReturnNo, customerName, dispatchrefNo, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), approvalStatus, companyId);
