...
namespace Portal.Core
{
    public class TBDrillDownBL
    {
        ...
        public ResponseOut GenerateTrialBalanceDrillDown(int companyId, int finYearId, DateTime fromDate, DateTime toDate, int reportUserId, string sessionId)
        {
            ...
            try
            {
                responseOut = sqlDbInterface.GenerateTrialBalanceDrillDown(companyId, finYearId, fromDate,toDate, reportUserId, sessionId);
            }
        ...
        public List<TBDrillDown_GLTypeViewModel> GetTBDrillDown_GLTypeList(int reportUserId, string sessionId, int glMainGroupId = 0,int glSubGroupId=0,int glId=0)
        {
            List<TBDrillDown_GLTypeViewModel> glTypeList = new List<TBDrillDown_GLTypeViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtGLTypeList = sqlDbInterface.GetTBDrillDown_GLTypeList(reportUserId, sessionId,glMainGroupId,glSubGroupId,glId);
        ...
        public List<TBDrillDown_MainGroupViewModel> GetTBDrillDown_MainGroupList(int reportUserId, string sessionId, int glMainGroupId = 0,int glSubGroupId=0, int glId = 0)
        {
            List<TBDrillDown_MainGroupViewModel> mainGroupList = new List<TBDrillDown_MainGroupViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtMainGroupList = sqlDbInterface.GetTBDrillDown_MainGroupList(reportUserId, sessionId, glMainGroupId, glSubGroupId,glId);
        ...
        public List<TBDrillDown_SubGroupViewModel> GetTBDrillDown_SubGroupList(int reportUserId, string sessionId, int glMainGroupId = 0, int glSubGroupId = 0,int glId=0)
        {
            List<TBDrillDown_SubGroupViewModel> subGroupList = new List<TBDrillDown_SubGroupViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtSubGroupList = sqlDbInterface.GetTBDrillDown_SubGroupList(reportUserId, sessionId, glMainGroupId,glSubGroupId,glId);
        ...
        public List<TBDrillDown_GLWiseViewModel> GetTBDrillDown_GLWiseList(int reportUserId, string sessionId, int glMainGroupId = 0, int glSubGroupId = 0, int glId = 0)
        {
            List<TBDrillDown_GLWiseViewModel> glWiseList = new List<TBDrillDown_GLWiseViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtGLWiseList = sqlDbInterface.GetTBDrillDown_GLWiseList(reportUserId, sessionId, glMainGroupId, glSubGroupId, glId);
        ...
        public List<TBDrillDown_SLWiseViewModel> GetTBDrillDown_SLWiseList(int reportUserId, string sessionId, int glMainGroupId = 0, int glSubGroupId = 0, int glId = 0)
        {
            List<TBDrillDown_SLWiseViewModel> slWiseList = new List<TBDrillDown_SLWiseViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtSLWiseList = sqlDbInterface.GetTBDrillDown_SLWiseList(reportUserId, sessionId, glMainGroupId, glSubGroupId, glId);
