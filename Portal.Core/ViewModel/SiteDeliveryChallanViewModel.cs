...
{
   public class SiteDeliveryChallanViewModel
    {
         
        public long SiteChallanId { get; set; }
        public string SiteChallanNo { get; set; }
        public string SiteChallanDate { get; set; }
        ...
        public string CustomerBranchAddress { get; set; }
        public string CustomerBranchGSTNo { get; set; }
    ...
    public class SiteChallanProductViewModel
    {
        public int SequenceNo { get; set; }
        public long SiteChallanProductDetailId { get; set; }
        public int SiteChallanId { get; set; }
    ...
    //}
    public class SiteChallanTermsViewModel
    {
        public long SiteChallanTermDetailId { get; set; }
        public int SiteChallanId { get; set; }
    ...
    public class SiteDeliveryChallanSupportingDocumentViewModel
    {
        public int DocumentSequenceNo { get; set; }
        public long SiteDeliveryChallanDocId { get; set; }
        public int SiteDeliveryChallanId { get; set; }
