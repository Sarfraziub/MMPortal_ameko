  ...
  public class CashVoucherBL
    {
        ...
        public List<VoucherViewModel> GetCashVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetCashVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId);
        ...
        public List<VoucherViewModel> GetApprovedCashVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedCashVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
        ...
        public DataTable GenerateCashVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateCashVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
