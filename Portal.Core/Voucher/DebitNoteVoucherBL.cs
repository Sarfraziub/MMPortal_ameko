  ...
  public class DebitNoteVoucherBL
    {
        ...
        public List<VoucherViewModel> GetDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetDebitNoteVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId);
        ...
        public List<VoucherViewModel> GetApprovedDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedDebitNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
        ...
        public DataTable GenerateDebitNoteVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateDebitNoteVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
