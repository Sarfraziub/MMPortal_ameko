  ...
  public class JournalVoucherBL
    {
        ...
        public List<VoucherViewModel> GetJournalVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetJournalVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId);
        ...
        public DataTable GenerateJournalVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateJournalVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public List<VoucherViewModel> GetApprovedJournalVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedJournalVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
