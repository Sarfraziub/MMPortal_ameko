  ...
  public class VoucherBL
    {
        ...
        public List<VoucherViewModel> GetBankVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetBankVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId);
        ...
        public DataTable GenerateBankVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateBankVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public List<VoucherViewModel> GetApprovedBankVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedBankVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId);
