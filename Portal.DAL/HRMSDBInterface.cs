...
namespace Portal.DAL
{
    ...
    public partial class HRMSDBInterface : IDisposable
    {
        ...
        public List<HR_ShiftType> GetHRShiftTypeList()
        {
            ...
            try
            {
                var hRshiftTypeList = entities.HR_ShiftType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_PositionLevel> GetPositionLevelList()
        {
            ...
            try
            {
                var positionlevels = entities.HR_PositionLevel.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_PositionType> GetPositionTypeList()
        {
            ...
            try
            {
                var positiontypes = entities.HR_PositionType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_HolidayType> GetHolidayTypeIdList()
        {
            List<HR_HolidayType> holidaytypeList = new List<HR_HolidayType>();
            try
            {
                var holidayTypes = entities.HR_HolidayType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_LoanType> GetEmployeeLoanApplicationTypeList()
        {
            ...
            try
            {
                var employeeLoanApplicationtypeList = entities.HR_LoanType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_Roaster> GetRosterList(int companyId)
        {
            ...
            try
            {
                var rosterList = entities.HR_Roaster.Where(x => x.CompanyId==companyId && x.Status == true).Select(s => new
                {
        ...
        public List<HR_AdvanceType> GetAdvanceTypeForEmpolyeeAdvanceAppList()
        {
            ...
            try
            {
                var advancetypes = entities.HR_AdvanceType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_TravelType> GetTravelTypeForEmpolyeeTravelAppList()
        {
            ...
            try
            {
                var traveltypes = entities.HR_TravelType.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_SeparationCategory> GetSeparationCategoryForSeparationApplicationList()
        {
            ...
            try
            {
                var separationcategorys = entities.HR_SeparationCategory.Where(x => x.status == true).Select(s => new
                {
        ...
        public List<HR_PMS_GoalCategory> GetPMSGoalCategoryList()
        {
            ...
            try
            {
                var pMSGoalCategoryList = entities.HR_PMS_GoalCategory.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_PMS_Section> GetPMSSectionList()
        {
            ...
            try
            {
                var pMSSectionList = entities.HR_PMS_Section.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_PMS_PerformanceCycle> GetPMSPerformanceCycleList()
        {
            ...
            try
            {
                var pMSPerformanceCycleList = entities.HR_PMS_PerformanceCycle.Where(x => x.Status == true).Select(s => new
                {
        ...
        public List<HR_Shift> GetShiftList(int companyId)
        {
            ...
            try
            {
                var shifts = entities.HR_Shift.Where(x => x.CompanyId==companyId && x.Status == true).Select(s => new
                {
                    ShiftId = s.ShiftId,
