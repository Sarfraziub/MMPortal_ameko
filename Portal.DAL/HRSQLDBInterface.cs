...
namespace Portal.DAL
{
    public class HRSQLDBInterface : IDisposable
    {
        ...
        public DataTable GetEmployeeAdvanceAppList(string applicationNo, int employeeId, string advanceTypeId, string advanceStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeTravelAppList(string applicationNo, int employeeId, string travelTypeId, string travelStatus, string travelDestination, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeAssetApplicationApprovalList(string applicationNo, int employeeId, string loanTypeName, string loanStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetInterviewList(string interviewNo, string applicantNo, string interviewFinalStatus, int companyId, DateTime fromDate, DateTime toDate)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetAppointmentList(string appointLetterNo, string interviewNo, string applicantName, string appointStatus, int companyId, DateTime fromDate, DateTime toDate)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    using (SqlCommand sqlCommand = new SqlCommand("proc_AddEditEmployeeAssetApplication", con))
                    {
                        ...
                        sqlCommand.Parameters.AddWithValue("@ApplicationStatus", "Final");
        ...
        public DataTable GetEmployeeAssetApplicationList(string applicationNo, int employeeId, string assetTypeName, string assetStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeTravelAppApprovalList(string applicationNo, int employeeId, string travelTypeId, string travelStatus, string travelDestination, DateTime fromDate, DateTime toDate, int companyId)
    {
        ...
        public DataTable GetEmployeeClaimApplicationList(string applicationNo, int employeeId, int claimTypeId, string claimStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeLeaveApplicationList(string applicationNo, int employeeId, string leaveTypeId, string leaveStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeLeaveApplicationApprovalList(string applicationNo, int employeeId, string leaveTypeId, string leaveStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeClaimApplicationApprovalList(string applicationNo, int employeeId, int claimTypeId, string claimStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public ResponseOut UpdateEmployeeRosterShift(int rosterId,int shiftId,DateTime startDate,DateTime endDate,int createdBy, List<HR_EmployeeRoster> employeeRosterList)
        {
            ResponseOut responseOut = new ResponseOut();
            try
            {
        ...
        public DataTable GetGoalList(string goalName, int sectionId, int goalCategoryId, int performanceCycleId,string goalStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetAppraisalTemplateLists(string templateName, int department, int designation, int companyId,  string appraisaltemplateStatus )
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeAppraisalTemplateMappingLists(string templateName, string employeeName, int companyId, string employeeAppraisalTemplateStatus)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetSeparationApplicationList(string applicationNo, int employeeId, string separationcategoryId, string applicationStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetSeparationApplicationApprovalList(string applicationNo, int employeeId, string separationcategoryId, string applicationStatus, DateTime fromDate, DateTime toDate, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetEmployeeAppraisalReviewList(string employeeName,string pmsFinalStatus,int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public ResponseOut AddEditEmployeeAttendance(int companyId, int employeeId, string attendanceDate, string presentAbsent, string inTime, string outTime, string attendanceStatus, int userId)
        {
            ResponseOut responseOut = new ResponseOut();
            try
            {
        ...
        public DataTable GetEmployeeAttendanceList(int employeeId, string attendanceDate, int departmentId, int designationId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    using (SqlCommand sqlCommand = new SqlCommand("proc_AddEditEmployeeAttendanceFormByEmployer", con))
                    {
                        ...
                        sqlCommand.Parameters.AddWithValue("@CustomerBranchId", employeeAttendance.CustomerBranchId);
        ...
        public DataTable GetEmployeeAttendanceReport(int month, int year, int roleId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetPayrollProcessPeriodList(int monthId, string payrollProcessStatus, string payrollLocked, int companyId)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
        ...
        public DataTable GetPayHeadGLMappingList(string payHeadName = "", int companyId = 0, string status = "")
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter();
            try
