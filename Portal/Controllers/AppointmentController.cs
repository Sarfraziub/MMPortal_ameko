...
namespace Portal.Controllers
{
    ...
    public class AppointmentController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetAppointmentList(string appointLetterNo="", string interviewNo="", string applicantName="", string appointStatus="", int companyId=0, string fromDate="", string toDate="")
        {
            ...
            try
            {
                appointments = appointmentBL.GetAppointmentList(appointLetterNo, interviewNo, applicantName, appointStatus, ContextUser.CompanyId, fromDate, toDate);
        ...
        [HttpGet]
        public PartialViewResult GetInterviewList(string interviewNo = "", string applicantNo = "", string interviewFinalStatus = "Final", int companyId = 0, string fromDate = "", string toDate = "")
        {
            ...
            try
            {
                interviews = interviewBL.GetInterviewList(interviewNo, applicantNo, interviewFinalStatus, ContextUser.CompanyId, fromDate, toDate);
