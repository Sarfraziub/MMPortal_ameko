...
namespace Portal.Controllers
{
    ...
    public class BookPrintController : BaseController
    {
        ...
        public ActionResult BankBookGenerate(int bookId, string fromDate, string toDate)
        {
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    responseOut = bankBookBL.GenerateBankBook(bookId,ContextUser.CompanyId, finYearId,Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate),ContextUser.UserId,Session.SessionID);
                }
                else
                {
        ...
        public ActionResult BankBookReport(string bookName,string fromDate,string toDate,string reportType = "PDF")
        {
            ...
            dt = bankBookPrintBL.GetBankBookDetailDataTable(ContextUser.UserId,Session.SessionID);
        ...
        public ActionResult JournalBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = journalBookBL.GenerateJournalBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult JournalBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            ...
            DataTable dt = new DataTable();
            dt = journalBookPrintBL.GetJournalBookDetailDataTable(ContextUser.UserId, Session.SessionID);
        ...
        public ActionResult CashBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = cashBookPrintBL.GenerateCashBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult CashBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            ...
            DataTable dt = new DataTable();
            dt = cashBookPrintBL.GetCashBookDetailDataTable(ContextUser.UserId, Session.SessionID);
        ...
        public ActionResult SaleBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = saleBookPrintBL.GenerateSaleBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult SaleBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            ...
            DataTable dt = new DataTable();
            dt = saleBookPrintBL.GetSaleBookDetailDataTable(ContextUser.UserId, Session.SessionID);
        ...
        public ActionResult PurchaseBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = purchaseBookPrintBL.GeneratePurchaseBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult PurchaseBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            ...
            DataTable dt = new DataTable();
            dt = purchaseBookPrintBL.GetPurchaseBookDetailDataTable(ContextUser.UserId, Session.SessionID);
        ...
        public ActionResult CreditNoteBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = creditNoteBookPrintBL.GenerateCreditNoteBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult CreditNoteBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            ...
            DataTable dt = new DataTable();
            dt = creditNoteBookPrintBL.GetCreditNoteBookDetailDataTable(ContextUser.UserId, Session.SessionID);
        ...
        public ActionResult DebitNoteBookGenerate(int bookId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            ...
            try
            {
                if (bookId != 0)
                {
                    ...
                    int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = debitNoteBookPrintBL.GenerateDebitNoteBook(bookId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.UserId, Session.SessionID);
                }
                else
                {
                    responseOut.message = ActionMessage.ProbleminData;
        ...
        public ActionResult DebitNoteBookReport(string bookName, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            DebitNoteBookPrintBL debitNoteBookPrintBL = new DebitNoteBookPrintBL();
            CompanyBL companyBL = new CompanyBL();
            ...
            DataTable dt = new DataTable();
            dt = debitNoteBookPrintBL.GetDebitNoteBookDetailDataTable(ContextUser.UserId, Session.SessionID);
