...
namespace Portal.Controllers
{
    ...
    public class CashVoucherController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetCashVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            ...
            try
            {
                vouchers = cashvoucherBL.GetCashVoucherList(bookId, voucherMode, voucherNo, voucherStatus,Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate),ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ActionResult GenerateCashVoucherReport(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();         
            CashVoucherBL cashVoucherBL = new CashVoucherBL();
            ...
            ReportDataSource rd = new ReportDataSource("CashVoucherReportDataSet", cashVoucherBL.GenerateCashVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId));
            lr.DataSources.Add(rd);
        ...
        [HttpGet]
        public PartialViewResult GetApprovedCashVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            ...
            try
            {
                vouchers = cashvoucherBL.GetApprovedCashVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
