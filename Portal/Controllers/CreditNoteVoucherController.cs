...
namespace Portal.Controllers
{
    ...
    public class CreditNoteVoucherController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetCreditNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            ...
            try
            {
                vouchers = creditnoteVoucherBL.GetCreditNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public PartialViewResult GetApprovedCreditNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            ...
            try
            {
                vouchers = creditnoteVoucherBL.GetApprovedCreditNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_CreditNoteVoucher, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult CancelApprovedCreditNoteVoucher(int voucherId = 0, int accessMode = 3)
        {
            try
            {
                FinYearViewModel finYear = Session[SessionKey.CurrentFinYear] != null ? (FinYearViewModel)Session[SessionKey.CurrentFinYear] : new FinYearViewModel();
