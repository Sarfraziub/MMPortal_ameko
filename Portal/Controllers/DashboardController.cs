...
namespace Portal.Controllers
{
    ...
    public class DashboardController : BaseController
    {
        ...
        [HttpPost]
        public string GetPendingPOLessThan25KCountList(int userId = 0, string selfOrTeam = "SELF")
        {
            PurchaseDashboardBL pOBL = new PurchaseDashboardBL();
            string PoCountPending = "";
            //POCountViewModel poCountViewModel = new POCountViewModel();
            try
            {
                FinYearViewModel currentFinYear = (FinYearViewModel)Session[SessionKey.CurrentFinYear];
                //int companyId, int userId, int reportingUserId, int reportingRoleId, int finYearId
                PoCountPending = pOBL.GetPendingPOLessThan25KCountList(ContextUser.CompanyId, ContextUser.UserId, ContextUser.UserId, ContextUser.RoleId, currentFinYear.FinYearId);
        ...
        [HttpPost]
        public PartialViewResult GetDashboardPendingStoreRequisition()
        {
            ...
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                storeRequisitionList = purchaseDashboardBL.GetDashboardPendingStoreRequisition(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpPost]
        public PartialViewResult GetDashboardRejectedStoreRequisition()
        {
            List<StoreRequisitionViewModel> storeRequisitionList = new List<StoreRequisitionViewModel>();
            PurchaseDashboardBL purchaseDashboardBL = new PurchaseDashboardBL();
            try
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                storeRequisitionList = purchaseDashboardBL.GetDashboardRejectedStoreRequisition(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpPost]
        public PartialViewResult GetPOPendingForMDApprovals()
        {
            List<POViewModel> poList = new List<POViewModel>();
            PurchaseDashboardBL purchaseDashboardBL = new PurchaseDashboardBL();
            try
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                poList = purchaseDashboardBL.GetPOPendingForMDApprovals(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpPost]
        public PartialViewResult GetPORejectedByMD()
        {
            List<POViewModel> poList = new List<POViewModel>();
            PurchaseDashboardBL purchaseDashboardBL = new PurchaseDashboardBL();
            try
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                poList = purchaseDashboardBL.GetPORejectedByMD(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
