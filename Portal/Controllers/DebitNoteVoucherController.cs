...
namespace Portal.Controllers
{
    ...
    public class DebitNoteVoucherController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            ...
            try
            {
                vouchers = debitnoteVoucherBL.GetDebitNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ActionResult GenerateDebitNoteVoucherReport(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();            
            DebitNoteVoucherBL debitNoteVoucherBL = new DebitNoteVoucherBL();
            ...
            ReportDataSource rd = new ReportDataSource("DebitNoteVoucherReportsDataSet", debitNoteVoucherBL.GenerateDebitNoteVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId));
            lr.DataSources.Add(rd);
        ...
        [HttpGet]
        public PartialViewResult GetApprovedDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            ...
            try
            {
                vouchers = debitnoteVoucherBL.GetApprovedDebitNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
