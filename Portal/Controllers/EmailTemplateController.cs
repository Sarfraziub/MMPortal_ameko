...
namespace Portal.Controllers
{
    ...
    public class EmailTemplateController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmailTemplateList(string emailTemplateSubject, int emailTemplateTypeId,string status)
        {
            ...
            try
            {
                    ...
                    emailTemplates = emailTemplateBL.GetEmailTemplateList(emailTemplateSubject, emailTemplateTypeId,ContextUser.CompanyId,status);
