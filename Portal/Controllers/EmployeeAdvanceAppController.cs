...
namespace Portal.Controllers
{
    ...
    public class EmployeeAdvanceAppController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeAdvanceAppList(string applicationNo = "", int employeeId = 0, string advanceTypeId = "",  string advanceStatus = "0", string fromDate = "", string toDate = "", int essEmployeeId = 0, string essEmployeeName = "")
        {
            ...
            try
            {
                ViewData["essEmployeeId"] = essEmployeeId;
                ViewData["essEmployeeName"] = essEmployeeName;
                employeeadvaneApplications = employeeadvanceAppBL.GetEmployeeAdvanceAppList(applicationNo, essEmployeeId, advanceTypeId,advanceStatus, fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
