...
namespace Portal.Controllers
{
    ...
    public class EmployeeAssetApplicationController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeAssetApplicationList(string applicationNo = "", int employeeId = 0, string assetTypeName = "", string assetStatus = "0", string fromDate = "", string toDate = "", int essEmployeeId = 0, string essEmployeeName = "")
        {
            ...
            try
            {
                ViewData["essEmployeeId"] = essEmployeeId;
                ViewData["essEmployeeName"] = essEmployeeName;
                employeeAssetApplicationViewModel = employeeAssetApplicationBL.GetEmployeeAssetApplicationList(applicationNo, essEmployeeId, assetTypeName, assetStatus, fromDate, toDate,ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeAssetApplicationApprovalList(string applicationNo = "", int employeeId = 0, string assetTypeName = "", string assetStatus = "0", string fromDate = "", string toDate = "")
        {
            List<EmployeeAssetApplicationViewModel> employeeAssetApplicationViewModel = new List<EmployeeAssetApplicationViewModel>();
            ...
            try
            {
                employeeAssetApplicationViewModel = employeeAssetApplicationBL.GetEmployeeAssetApplicationApprovalList(applicationNo, employeeId, assetTypeName, assetStatus, fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
