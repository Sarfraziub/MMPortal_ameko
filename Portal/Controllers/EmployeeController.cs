...
namespace Portal.Controllers
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        [HttpGet]
        public JsonResult GetTempEmployeeAutoCompleteList(string term, int departmentId = 0, int designationId = 0)
        {
            EmployeeBL employeeBL = new EmployeeBL();
            ...
            try
            {
                employeeList = employeeBL.GetTempEmployeeAutoCompleteList(term, departmentId, designationId);
