...
namespace Portal.Controllers
{
    ...
    public class EmployeeLeaveApplicationController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeLeaveApplicationList(string applicationNo = "", int employeeId = 0, string leaveTypeId = "", string leaveStatus = "0", string fromDate = "", string toDate = "", int essEmployeeId = 0, string essEmployeeName = "")
        {
            ...
            try
            {
                ViewData["essEmployeeId"] = essEmployeeId;
                ViewData["essEmployeeName"] = essEmployeeName;
                employeeleaveApplications = employeeleaveAppBL.GetEmployeeLeaveApplicationList(applicationNo, essEmployeeId, leaveTypeId, leaveStatus,fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeLeaveApplicationApprovalList(string applicationNo = "", int employeeId = 0, string leaveTypeId = "", string leaveStatus = "0", string fromDate = "", string toDate = "")
        {
            List<EmployeeLeaveApplicationViewModel> employeeleaveApplications = new List<EmployeeLeaveApplicationViewModel>();
            EmployeeLeaveApplicationBL employeeleaveAppBL = new EmployeeLeaveApplicationBL();
            try
            {
                employeeleaveApplications = employeeleaveAppBL.GetEmployeeLeaveApplicationApprovalList(applicationNo, employeeId, leaveTypeId, leaveStatus, fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
