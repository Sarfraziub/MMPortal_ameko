...
namespace Portal.Controllers
{
    ...
    public class EmployeeTravelAppController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeTravelAppList(string applicationNo = "", int employeeId = 0, string travelTypeId = "",  string travelStatus = "0", string travelDestination="", string fromDate = "", string toDate = "", int essEmployeeId = 0, string essEmployeeName = "")
        {
            ...
            try
            {
                ViewData["essEmployeeId"] = essEmployeeId;
                ViewData["essEmployeeName"] = essEmployeeName;
                employeetravelApplications = employeetravelAppBL.GetEmployeeTravelAppList(applicationNo, essEmployeeId, travelTypeId, travelStatus, travelDestination,fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
