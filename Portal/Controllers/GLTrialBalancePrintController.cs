...
namespace Portal.Controllers
{
    ...
    public class GLTrialBalancePrintController : BaseController
    {
        ...
        public ActionResult GLTrialBalance2ColumnGenerate(string asOnDate)
        {
            ...
            try
            {
                ...
                responseOut = trialPrintBL.GenerateGLTrialBalance2Column(ContextUser.CompanyId, finYearId, Convert.ToDateTime(asOnDate),ContextUser.UserId,Session.SessionID);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GLTrialBalance2ColumnReport(string asOnDate,string reportType = "PDF")
        {
            ...
            dt = trialPrintBL.GetGLTrialBalance2ColumnDataTable(ContextUser.UserId,Session.SessionID);
