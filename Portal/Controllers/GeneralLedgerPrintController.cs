...
namespace Portal.Controllers
{
    ...
    public class GeneralLedgerPrintController : BaseController
    {
        ...
        public ActionResult GeneralLedgerGenerate(int glId, string fromDate, string toDate)
        {
            ...
            try
            {
                    ...
                    responseOut = glPrintBL.GenerateGeneralLedger(glId, ContextUser.CompanyId, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate),ContextUser.UserId,Session.SessionID);
