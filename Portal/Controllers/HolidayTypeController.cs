...
namespace Portal.Controllers
{
    ...
    public class HolidayTypeController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetHolidayTypeList(string holidaytypeName = "", string holidaytypeStatus = "")
        {
            List<HolidayTypeViewModel> holidaytypes = new List<HolidayTypeViewModel>();
            HolidayTypeBL holidaytypeBL = new HolidayTypeBL();
            try
            {
                holidaytypes = holidaytypeBL.GetHolidayTypeList(holidaytypeName, holidaytypeStatus);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
