...
namespace Portal.Controllers
{
    ...
    public class InterviewController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetInterviewList(string interviewNo="", string applicantNo="", string interviewFinalStatus="", int companyId=0, string fromDate="", string toDate="")
        {
