...
namespace Portal.Controllers
{
    ...
    public class JournalVoucherController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetJournalVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            ...
            try
            {
                vouchers = journalVoucherBL.GetJournalVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ActionResult GenerateJournalVoucherReport(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();          
            JournalVoucherBL journalVoucherBL = new JournalVoucherBL();
            ...
            ReportDataSource rd = new ReportDataSource("JournalVoucherReportsDataSet", journalVoucherBL.GenerateJournalVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId));
            lr.DataSources.Add(rd);
        ...
        [HttpGet]
        public PartialViewResult GetApprovedJournalVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, string fromDate, string toDate)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            ...
            try
            {
                vouchers = journalVoucherBL.GetApprovedJournalVoucherList(bookId, voucherMode, voucherNo, voucherStatus, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
