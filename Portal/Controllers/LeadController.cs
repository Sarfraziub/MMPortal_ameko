...
namespace Portal.Controllers
{
    ...
    public class LeadController : BaseController
    {
        ...
        public PartialViewResult GetLeadList(string leadCode = "", string companyName = "",  string contactPersonName = "", string email = "", string contactNo = "", string companyAddress = "", string companyCity = "", int companyStateId = 0, int leadSourceId = 0, int leadStatusId = 0,int leadSourceType=0 ,int userId=0,string status = "")
        { 
            ...
            try
            {
                if (leadSourceType==2)
                {
                    leads = leadBL.GetLeadList(leadCode, companyName, contactPersonName, email, contactNo, companyAddress, companyCity, companyStateId, leadStatusId, leadSourceId, userId, status, ContextUser.UserId, ContextUser.RoleId);
                }
                else
                {
                    leads = leadBL.GetLeadList(leadCode, companyName, contactPersonName, email, contactNo, companyAddress, companyCity, companyStateId, leadStatusId, leadSourceId, ContextUser.UserId, status,ContextUser.UserId,ContextUser.RoleId);
                }
        ...
        public ActionResult GenerateLeadReport(string leadCode = "", string companyName = "", string contactPersonName = "", string email = "", string contactNo = "", string companyAddress = "", string companyCity = "", int companyStateId = 0, int leadSourceId = 0, int leadStatusId = 0, int leadSourceType = 0, int userId = 0, string status = "", string reportType = "PDF")
        {
            ...
            if (leadSourceType == 2)
            {
                ReportDataSource rd = new ReportDataSource("LeadReportDataSet", leadBL.GenerateLeadReport(leadCode, companyName, contactPersonName, email, contactNo, companyAddress, companyCity, companyStateId, leadStatusId, leadSourceId, userId, status, ContextUser.UserId, ContextUser.RoleId));
                lr.DataSources.Add(rd);
            }
            else
            {
                ReportDataSource rd = new ReportDataSource("LeadReportDataSet", leadBL.GenerateLeadReport(leadCode, companyName, contactPersonName, email, contactNo, companyAddress, companyCity, companyStateId, leadStatusId, leadSourceId, ContextUser.UserId, status, ContextUser.UserId, ContextUser.RoleId));
                lr.DataSources.Add(rd);
            }
