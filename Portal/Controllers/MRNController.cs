...
namespace Portal.Controllers
{
    ...
    public class MRNController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetPOListForMRN(string poNo = "", string vendorName = "", string refNo = "", string fromDate = "", string toDate = "", string approvalStatus = "", string displayType = "")
        {
            ...
            try
            {
                pos = poBL.GetPOListForMRN(poNo, vendorName, refNo, fromDate, toDate, approvalStatus, ContextUser.CompanyId, displayType);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpPost]
        public PartialViewResult GetPOProductListForMRN(List<PurchaseInvoiceProductDetailViewModel> poProducts, long invoiceId)
        {
            POBL poBL = new POBL();
            try
            {
                if (poProducts == null)
                {
                    poProducts = poBL.GetPOProductListForMRN(invoiceId);
                }
