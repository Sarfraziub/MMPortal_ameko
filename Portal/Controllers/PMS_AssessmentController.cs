...
namespace Portal.Controllers
{
    ...
    public class PMS_AssessmentController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeSelfAssessmentList(string templateName = "", string employeeName = "",string employeeMapping_Status="1")
        {
            ...
            try
            {
                appraisalTemplates = appraisalTemplateBL.GetEmployeeAppraisalTemplateMappingList(templateName, employeeName, ContextUser.CompanyId, "1");
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public PartialViewResult GetAppraiserAssessmentList(string templateName = "", string employeeName = "", string employeeMapping_Status = "1")
        {
            List<PMS_EmployeeAppraisalTemplateMappingViewModel> appraisalTemplates = new List<PMS_EmployeeAppraisalTemplateMappingViewModel>();
            PMS_EmployeeAppraisalTemplateMappingBL appraisalTemplateBL = new PMS_EmployeeAppraisalTemplateMappingBL();
            try
