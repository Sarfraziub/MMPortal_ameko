...
namespace Portal.Controllers
{
    ...
    public class PMS_EmployeeAppraisalTemplateMappingController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetEmployeeAppraisalTemplateMappingList(string templateName = "", string employeeName = "",string employeeMapping_Status="")
        {
            ...
            try
            {
                appraisalTemplates = appraisalTemplateBL.GetEmployeeAppraisalTemplateMappingList(templateName, employeeName, ContextUser.CompanyId, employeeMapping_Status);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
