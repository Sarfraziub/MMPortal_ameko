...
namespace Portal.Controllers
{
    ...
    public class PayHeadGLMappingController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetPayHeadGLMappingList(string payHeadName = "", string status = "")
        {
            ...
            try
            {
                payHeadGLMappingViewModels = payHeadGLMappingBL.GetPayHeadGLMappingList(payHeadName, ContextUser.CompanyId, status);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
