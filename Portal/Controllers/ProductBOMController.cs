...
namespace Portal.Controllers
{
    ...
    {      
        ...
        public ActionResult Report(long assemblyId, string assemblyType,string reportType = "PDF")
        {
            ...
            dt = productBOMBL.GetBOMListReport(assemblyId, assemblyType,ContextUser.CompanyId);
