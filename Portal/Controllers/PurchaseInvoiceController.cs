...
namespace Portal.Controllers
{
    ...
    public class PurchaseInvoiceController :BaseController
    {
        ...
        public ActionResult AddEditPI(PurchaseInvoiceViewModel piViewModel, List<PurchaseInvoiceProductDetailViewModel> piProducts, List<PurchaseInvoiceTaxDetailViewModel> piTaxes, List<PurchaseInvoiceTermsDetailViewModel> piTerms, List<PISupportingDocumentViewModel> piDocuments)
        {
            ...
            try
            {
                if (piViewModel != null)
                {
                    ...
                    responseOut = purchaseInvoiceBL.AddEditPI(piViewModel, piProducts, piTaxes, piTerms, piDocuments);
                }
                else
                {
        ...
        public PartialViewResult GetPurchaseOrderList(string poNo = "", string vendorName = "", string refNo = "", string fromDate = "", string toDate = "", string approvalStatus = "", string displayType = "")
        {
            ...
            try
            {
                poList = piBL.GetPOListForPI(poNo, vendorName, refNo, fromDate, toDate, approvalStatus, ContextUser.CompanyId, displayType);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
