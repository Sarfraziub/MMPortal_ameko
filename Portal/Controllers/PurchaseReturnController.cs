...
namespace Portal.Controllers
{
    ...
    public class PurchaseReturnController : BaseController
    {
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_PurchaseReturn, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        ...
        [HttpGet]
        public PartialViewResult GetPurchaseReturnList(string purchaseReturnNo = "", string vendorName = "", string dispatchrefNo = "", string fromDate = "", string toDate = "", string approvalStatus = "")
        {
            List<PurchaseReturnViewModel> purchaseReturnViewModel = new List<PurchaseReturnViewModel>();
            PurchaseReturnBL purchaseReturnBL = new PurchaseReturnBL();
            try
            {
                purchaseReturnViewModel = purchaseReturnBL.GetPurchaseReturnList(purchaseReturnNo, vendorName, dispatchrefNo, fromDate, toDate, approvalStatus, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
