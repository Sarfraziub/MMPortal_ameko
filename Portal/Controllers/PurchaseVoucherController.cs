...
namespace Portal.Controllers
{
    ...
    public class PurchaseVoucherController : BaseController
    {
       ...
       [ValidateRequest(true, UserInterfaceHelper.Add_Edit_PurchaseVoucher, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult AddEditPurchaseVoucher(int voucherId = 0, int accessMode = 3, string ReportLevel = "", string FromDate = "", string ToDate = "", string StartInterface = "", int GLMainGroupId = 0, int GLSubGroupId = 0, Int32 GLId = 0, Int32 SLId = 0)
        {
            try
            {
