...
namespace Portal.Controllers
{
    ...
    public class ResourceRequisitionController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetResourceRequisitionList(string requisitionNo = "", int positionLevelId = 0, string priorityLevel = "", int positionTypeId = 0, int departmentId = 0, string approvalStatus = "0", string fromDate = "",string toDate="")
        {
