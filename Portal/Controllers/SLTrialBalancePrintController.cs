...
namespace Portal.Controllers
{
    ...
    public class SLTrialBalancePrintController : BaseController
    {
        ...
        public ActionResult SLTrialBalanceGenerate(int slTypeId,int glId,string asOnDate)
        {
            ...
            try
            {
                ...
                responseOut = trialPrintBL.GenerateSLTrialBalance(slTypeId,glId, ContextUser.CompanyId, finYearId, Convert.ToDateTime(asOnDate),ContextUser.UserId,Session.SessionID);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SLTrialBalanceReport(string asOnDate,string reportType = "PDF")
        {
            ...
            dt = trialPrintBL.GetSLTrialBalanceDataTable(ContextUser.UserId,Session.SessionID);
