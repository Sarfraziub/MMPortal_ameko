...
namespace Portal.Controllers
{
    ...
    public class SORegisterController : BaseController
    {
        ...
        public ActionResult GenerateSORegisterReports(int customerId = 0, int stateId = 0, int shippingstateId = 0, string fromDate = "", string toDate = "", int createdBy = 0, string sortBy = "", string sortOrder = "", string reportType = "PDF")
        {
            ...
            ReportDataSource rd = new ReportDataSource("SORegisterReportsDataSet", sORegisterBL.GenerateSORegisterReports(customerId, stateId, shippingstateId, fromDate, toDate, createdBy, ContextUser.CompanyId, sortBy, sortOrder));
