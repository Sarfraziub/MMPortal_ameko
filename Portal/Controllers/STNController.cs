...
namespace Portal.Controllers
{
    ...
    public class STNController : BaseController
    {
        ...
        public ActionResult AddEditSTN(STNViewModel stnViewModel, List<STNProductDetailViewModel> stnProductDetailViewModel, List<STNSupportingDocumentViewModel> stnDocuments)
        {
            ...
            try
            {
                if (stnViewModel != null)
                {
                    ...
                    responseOut = stnBL.AddEditSTN(stnViewModel,stnProductDetailViewModel, stnDocuments);
