...
namespace Portal.Controllers
{
    ...
    public class STRController : BaseController
    {
        ...
        public ActionResult AddEditSTR(STRViewModel strViewModel, List<STRProductDetailViewModel> strProductDetailViewModel, List<STRSupportingDocumentViewModel> strDocuments)
        {
            ...
            try
            {
                if (strViewModel != null)
                {
                    ...
                    responseOut = stnBL.AddEditSTR(strViewModel, strProductDetailViewModel, strDocuments);
