...
namespace Portal.Controllers
{
    ...
    public class SaleInvoiceRegisterController : BaseController
    {
        ...
        public ActionResult GenerateSaleInvoiceRegisterReports(int customerId = 0, int stateId = 0, int shippingstateId = 0, string fromDate = "", string toDate = "", int createdBy = 0, string sortBy = "", string sortOrder = "", string reportType = "PDF")
        {
            ...
            ReportDataSource rd = new ReportDataSource("SaleInvoiceRegisterReportsDataSet", saleinvoiceregisterBL.GenerateSaleInvoiceRegisterReports(customerId, stateId, shippingstateId, fromDate, toDate, ContextUser.CompanyId, createdBy,  sortBy, sortOrder));
