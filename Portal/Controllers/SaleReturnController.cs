...
namespace Portal.Controllers
{
    ...
    public class SaleReturnController : BaseController
    {
        ...
        public ActionResult AddEditSaleReturn(SaleReturnViewModel saleReturnViewModel, List<SaleReturnProductViewModel> saleReturnProducts)
        {
            ...
            try
            {
                if (saleReturnViewModel != null)
                {
                    ...
                    responseOut = saleReturnBL.AddEditSaleReturn(saleReturnViewModel, saleReturnProducts);
        ...
        [HttpGet]
        public PartialViewResult GetSaleReturnList(string saleReturnNo = "", string customerName = "", string dispatchrefNo = "", string fromDate = "", string toDate = "",string approvalStatus="")
        {
            List<SaleReturnViewModel> saleReturnViewModel = new List<SaleReturnViewModel>();
            SaleReturnBL saleReturnBL = new SaleReturnBL();
            try
            {
                saleReturnViewModel = saleReturnBL.GetSaleReturnList(saleReturnNo, customerName, dispatchrefNo, fromDate, toDate, approvalStatus, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
