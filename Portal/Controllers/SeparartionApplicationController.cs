...
namespace Portal.Controllers
{
    ...
    public class SeparationApplicationController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetSeparationApplicationList(string applicationNo = "", int employeeId = 0, string separationcategoryId = "",  string applicationStatus = "0", string fromDate = "", string toDate = "")
        {
            List<SeparationApplicationViewModel> separationApplications = new List<SeparationApplicationViewModel>();
            SeparationApplicationBL separationApplicationBL = new SeparationApplicationBL();
            try
            {
                separationApplications = separationApplicationBL.GetSeparationApplicationList(applicationNo, employeeId, separationcategoryId, applicationStatus, fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public PartialViewResult GetSeparationApplicationApprovalList(string applicationNo = "", int employeeId = 0, string separationcategoryId = "", string applicationStatus = "0", string fromDate = "", string toDate = "")
        {
            List<SeparationApplicationViewModel> separationApplications = new List<SeparationApplicationViewModel>();
            SeparationApplicationBL separationApplicationBL = new SeparationApplicationBL();
            try
            {
                separationApplications = separationApplicationBL.GetSeparationApplicationApprovalList(applicationNo, employeeId, separationcategoryId, applicationStatus, fromDate, toDate, ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
