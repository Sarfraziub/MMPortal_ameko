...
namespace Portal.Controllers
{
    ...
    public class StockLedgerController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetStockLedgerList(int productTypeId, string assemblyType, int productMainGroupId, int productSubGroupId, long productId, int customerBranchId, string fromDate, string toDate)
        {
        ...
        [HttpGet]
        public PartialViewResult GetStockLedgerDrilDownList(long productId,string fromDate, string toDate)
        {
            FinYearViewModel finYear = Session[SessionKey.CurrentFinYear] != null ? (FinYearViewModel)Session[SessionKey.CurrentFinYear] : new FinYearViewModel();
            ...
            try
            {
                ...
                stockLedgerViewModel = stockLedgerBL.GetStockLedgerDrilDownList(productId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate),ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ActionResult StockLedgerReport(int productTypeId = 0, string assemblyType = "", int productMainGroupId = 0, int productSubGroupId = 0, long productId = 0, int customerBranchId = 0, string fromDate = "", string toDate = "", string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            StockLedgerBL stockLedgerBL = new StockLedgerBL();
