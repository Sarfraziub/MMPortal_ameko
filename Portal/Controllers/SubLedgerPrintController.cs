...
namespace Portal.Controllers
{
    ...
    public class SubLedgerPrintController : BaseController
    {
        ...
        public ActionResult SubLedgerGenerate(int slTypeId, int glId,long slId, string fromDate, string toDate)
        {
            ResponseOut responseOut = new ResponseOut();
            SubLedgerWOFYPrintBL slPrintBL = new SubLedgerWOFYPrintBL();
            try
            {
                responseOut = slPrintBL.GenerateSubLedger(slTypeId,glId,slId, ContextUser.CompanyId, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate),ContextUser.UserId,Session.SessionID);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SubLedgerWoFySingleGLReport(string fromDate,string toDate,string reportType = "PDF")
        {
            ...
            dt = slPrintBL.GetSubLedgerDetailDataTable(ContextUser.UserId,Session.SessionID);
        ...
        public ActionResult SubLedgerWoFyAllGLReport(string fromDate, string toDate, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            SubLedgerWOFYPrintBL slPrintBL = new SubLedgerWOFYPrintBL();
            CompanyBL companyBL = new CompanyBL();
