...
namespace Portal.Controllers
{
    ...
    public class SupervisorDashboardController : BaseController
    {
        //
        // GET: /ModuleDashboard/
        ...
        //SupervisorDashboard Section Start-----------------
        ...
        [HttpPost]
        public PartialViewResult GetSupervisorDashboardRejectedStoreRequisition()
        {
            List<StoreRequisitionViewModel> storeRequisitionList = new List<StoreRequisitionViewModel>();
            SupervisorDashboardBL supervisorDashboardBL = new SupervisorDashboardBL();
            try
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                storeRequisitionList = supervisorDashboardBL.GetSupervisorDashboardRejectedStoreRequisition(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpPost]
        public PartialViewResult GetSupervisorDashboardPendingStoreRequisition()
        {
            List<StoreRequisitionViewModel> storeRequisitionList = new List<StoreRequisitionViewModel>();
            SupervisorDashboardBL supervisorDashboardBL = new SupervisorDashboardBL();
            try
            {
                int finYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                storeRequisitionList = supervisorDashboardBL.GetSupervisorDashboardPendingStoreRequisition(ContextUser.CompanyId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
