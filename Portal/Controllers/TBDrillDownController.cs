...
namespace Portal.Controllers
{
    ...
    public class TBDrillDownController : BaseController
    {
        ...
        public ActionResult TrialBalanceDrillDownGenerate(string fromDate, string toDate)
        {
            ...
            try
            {
                    ...
                    responseOut = tbBL.GenerateTrialBalanceDrillDown(ContextUser.CompanyId, finYearId, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate),ContextUser.UserId,Session.SessionID);
            }
            catch (Exception ex)
            {
        ...
        [ValidateRequest(true, UserInterfaceHelper.TBDrillDown, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult MainGroupWiseTBDrillDown(string reportLevel,string fromDate,string toDate,int gLMainGroupId=0)
        {
            TBDrillDownBL tbBL = new TBDrillDownBL();
            ...
            try
            {
                ...
                tbDrillDownViewModel.GLTypeList = tbBL.GetTBDrillDown_GLTypeList(ContextUser.UserId, Session.SessionID);
                tbDrillDownViewModel.MainGroupList= tbBL.GetTBDrillDown_MainGroupList(ContextUser.UserId, Session.SessionID);
        ...
        [ValidateRequest(true, UserInterfaceHelper.TBDrillDown, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult SubGroupWiseTBDrillDown(string reportLevel, string fromDate, string toDate,string startInterface="",int gLMainGroupId=0, int gLSubGroupId = 0)
        {
            TBDrillDownBL tbBL = new TBDrillDownBL();
            TBDrillDownViewModel tbDrillDownViewModel = new TBDrillDownViewModel();
            try
            {
                ...
                tbDrillDownViewModel.GLTypeList = tbBL.GetTBDrillDown_GLTypeList(ContextUser.UserId, Session.SessionID, gLMainGroupId);
                tbDrillDownViewModel.MainGroupList = tbBL.GetTBDrillDown_MainGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId);
                tbDrillDownViewModel.SubGroupList = tbBL.GetTBDrillDown_SubGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId);
                ViewData["reportLevel"] = reportLevel;
                ViewData["fromDate"] = fromDate;
                ViewData["toDate"] = toDate;
        ...
        [ValidateRequest(true, UserInterfaceHelper.TBDrillDown, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult GLWiseTBDrillDown(string reportLevel, string fromDate, string toDate, string startInterface = "", int gLMainGroupId = 0, int gLSubGroupId = 0, int glId = 0)
        {
            TBDrillDownBL tbBL = new TBDrillDownBL();
            TBDrillDownViewModel tbDrillDownViewModel = new TBDrillDownViewModel();
            try
            {
                ...
                tbDrillDownViewModel.GLTypeList = tbBL.GetTBDrillDown_GLTypeList(ContextUser.UserId, Session.SessionID, gLMainGroupId,gLSubGroupId);
                tbDrillDownViewModel.MainGroupList = tbBL.GetTBDrillDown_MainGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId,gLSubGroupId);
                tbDrillDownViewModel.SubGroupList = tbBL.GetTBDrillDown_SubGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId);
                tbDrillDownViewModel.GLWiseList= tbBL.GetTBDrillDown_GLWiseList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId,glId);
                ViewData["reportLevel"] = reportLevel;
                ViewData["fromDate"] = fromDate;
                ViewData["toDate"] = toDate;
        ...
        [ValidateRequest(true, UserInterfaceHelper.TBDrillDown, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult SLWiseTBDrillDown(string reportLevel, string fromDate, string toDate, string startInterface = "", int gLMainGroupId = 0, int gLSubGroupId = 0, int glId = 0,Int32 slId=0)
        {
            TBDrillDownBL tbBL = new TBDrillDownBL();
            TBDrillDownViewModel tbDrillDownViewModel = new TBDrillDownViewModel();
            try
            {
                ...
                tbDrillDownViewModel.GLTypeList = tbBL.GetTBDrillDown_GLTypeList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId,glId);
                tbDrillDownViewModel.MainGroupList = tbBL.GetTBDrillDown_MainGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId,glId);
                tbDrillDownViewModel.SubGroupList = tbBL.GetTBDrillDown_SubGroupList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId,glId);
                tbDrillDownViewModel.GLWiseList = tbBL.GetTBDrillDown_GLWiseList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId, glId);
                tbDrillDownViewModel.SLWiseList = tbBL.GetTBDrillDown_SLWiseList(ContextUser.UserId, Session.SessionID, gLMainGroupId, gLSubGroupId, glId);
                ViewData["reportLevel"] = reportLevel;
                ViewData["fromDate"] = fromDate;
                ViewData["toDate"] = toDate;
