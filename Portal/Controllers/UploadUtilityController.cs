...
namespace Portal.Controllers
{
    ...
    public class UploadUtilityController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult ImportLead()
        {
            try
            {
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportGLMainGroup, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportGLSubGroup, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        #region Import SL
        [ValidateRequest(true, UserInterfaceHelper.ImportSL, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportDepartment, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportDesignation, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportProductMainGroup, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportProductBOM, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportProductOpeningStock, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        #region Import GL
        [ValidateRequest(true, UserInterfaceHelper.ImportGL, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportGLDetail, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportSLDetail, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
                    ...
                    if (validFileTypes.Contains(extension))
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dr in dt.Rows)
                            {
                                ...
                                if (!string.IsNullOrEmpty(Convert.ToString(dr["SLCode"])))
                                {
                                    sLId = utilityBL.GetIdBySLHead(Convert.ToString(dr["SLCode"]));
                                    if (sLId == 0)
                                    {
                                        strErrMsg.Append("Invalid SLCode data in Row #" + rowCounter.ToString() + Environment.NewLine);
                                        rowVerifyStatus = false;
                                    }
                                }
                                if (rowVerifyStatus == true)
                                {
                                    //End of code to get Id from Name data in excel//
                                    sLDetailViewModel.GLId = GLId;
                                    sLDetailViewModel.SLId = sLId;
                                    sLDetailViewModel.OpeningBalanceDebit = Convert.ToDecimal(dr["OpeningBalanceDebit"]);
                                    sLDetailViewModel.OpeningBalanceCredit = Convert.ToDecimal(dr["OpeningBalanceCredit"]);
                                    sLDetailViewModel.OpeningBalance = ((Convert.ToDecimal(dr["OpeningBalanceDebit"])) - (Convert.ToDecimal(dr["OpeningBalanceCredit"])));
                                    sLDetailViewModel.CompanyId = ContextUser.CompanyId;
                                    sLDetailViewModel.FinYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                                    sLDetailViewModel.CreatedBy = ContextUser.UserId;
                                    sLDetailViewModel.Status = true;

                                    ResponseOut responseOut = sLDetailBL.ImportSLDetail(sLDetailViewModel);
                                    if (responseOut.status == ActionStatus.Fail)
                                    {
                                        strErrMsg.Append(responseOut.message + ": Error in Inserting in Row #" + rowCounter.ToString() + Environment.NewLine);
                                        dr["UploadStatus"] = false;
        ...
        #region Import Size
        [ValidateRequest(true, UserInterfaceHelper.ImportSize, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
        ...
        [ValidateRequest(true, UserInterfaceHelper.ImportManufacturer, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        [HttpGet]
