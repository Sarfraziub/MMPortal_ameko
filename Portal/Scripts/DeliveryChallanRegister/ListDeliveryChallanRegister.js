...
function GenerateReportParameters() {
    ...
    var url = "../DeliveryChallanRegister/GenerateDeliveryChallanRegisterReports?customerId=" + $("#hdnCustomerId").val() + "&stateId=" + $("#ddlState").val() + "&shippingstateId=" + $("#ddlShippingState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#txtFromDate").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../DeliveryChallanRegister/GenerateDeliveryChallanRegisterReports?customerId=" + $("#hdnCustomerId").val() + "&stateId=" + $("#ddlState").val() + "&shippingstateId=" + $("#ddlShippingState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#txtFromDate").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&reportType=Excel";
