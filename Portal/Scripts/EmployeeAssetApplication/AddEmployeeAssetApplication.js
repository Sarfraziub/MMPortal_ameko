...
function SaveData() {
    ...
    var employeeAssetApplicationViewModel = {
        ...
        AssetStatus: ddlAssetStatus.val()
    };
    ...
    $.ajax({
        url: "../EmployeeAssetApplication/AddEditEmployeeAssetApplication",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../EmployeeAssetApplication/AddEditEmployeeAssetApplication?applicationId=" + data.trnId + "&essEmployeeId=" + hdnEssEmployeeId.val() + "&essEmployeeName=" + hdnEssEmployeeName.val() + "&AccessMode=2";
                   }, 2000);
