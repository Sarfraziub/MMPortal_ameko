    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.ApprovalStatus == "") {
                $("#ddlPOApprovel").val("Approved");
            }
            else {
                $("#ddlPOApprovel").val(data.ApprovalStatus);
            }

            if (data.ApprovalStatus == "Canceled" || data.ApprovalStatus == "Recommendation") {
...
function SaveData() {
    ...
    if (ddlPOApprovel.val() == "Canceled") {
        if (txtRejectedReason.val() == "") {
            ShowModel("Alert", "Please Enter PO Cancel Reason");
            return false;

        }
    }

    if (ddlPOApprovel.val() == "Recommendation") {
        if (txtRejectedReason.val() == "") {
            ShowModel("Alert", "Please Enter PO Recommendation Reason");
            return false;
    ...
    $.ajax({
        url: "../PO/ApprovalPO?AccessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
...
function EnableDisableRejectReason() {
    ...
    if (approvalStatus == "Reject") {
        $("#txtRejectedReason").attr("disabled", false);
        $("#txtRejectedReason").attr('placeholder', 'Enter Rejected Remarks');
        $("#lblRejectedReason").text('Enter Rejected Remarks').append('<span class="Mandatory" id="spnMandatoryRemarks">(*)</span>');
        $("#spnMandatoryRemarks").css('display', 'inline');
    }
    else if (approvalStatus == "Recommendation")
    {
        $("#txtRejectedReason").attr("disabled", false);
        $("#txtRejectedReason").attr('placeholder', 'Enter Recommendation Remarks');
        $("#lblRejectedReason").text('Enter Recommendation Remarks').append('<span class="Mandatory" id="spnMandatoryRemarks">(*)</span>');;
        $("#spnMandatoryRemarks").css('display', 'inline');
    }
    else {
        $("#txtRejectedReason").attr("disabled", true);
        $("#txtRejectedReason").val("");
        $("#txtRejectedReason").attr('placeholder', 'Enter Approved Remarks');
        $("#lblRejectedReason").text('Enter Approved Remarks');
    }
}
