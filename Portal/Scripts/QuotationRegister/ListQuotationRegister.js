...
function GenerateReportParameters() {
    ...
    var url = "../QuotationRegister/GenerateQuotationRegisterReports?customerId=" + $("#hdnCustomerId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#txtFromDate").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../QuotationRegister/GenerateQuotationRegisterReports?customerId=" + $("#hdnCustomerId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#txtFromDate").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&reportType=Excel";
