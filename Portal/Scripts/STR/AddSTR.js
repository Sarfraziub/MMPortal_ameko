...
function SaveData() {
    ...
    var requestData = { strViewModel: STRViewModel, strProductDetailViewModel: strProductList, strDocuments: strDocumentList };
    $.ajax({
...
function ResetPage() {
    if (confirm("Are you sure to reset all fields?")) {
        window.location.href = "../STR/AddEditSTR?accessMode=1";
    }
}
