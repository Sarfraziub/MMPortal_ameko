...
function SaveData() {
    ...
    var requestData = { saleReturnViewModel: saleReturnViewModel, saleReturnProducts: saleReturnProductList };
    $.ajax({
...
function ResetPage() {
    if (confirm("Are you sure to reset all fields?")) {
        window.location.href = "../SaleReturn/AddEditSaleReturn?accessMode=1";
    }
}