...
function SaveData() {
    ...
    $.ajax({
        url: "../EmployeeTravelApp/AddEditEmployeeTravelApp",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../EmployeeTravelApp/AddEditEmployeeTravelApp?applicationId=" + data.trnId +"&essEmployeeId=" + hdnEssEmployeeId.val() + "&essEmployeeName=" + hdnEssEmployeeName.val() +  "&AccessMode=2";
                   }, 2000);
