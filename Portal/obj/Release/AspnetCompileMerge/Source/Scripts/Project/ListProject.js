...
function SearchProject() {
    ...
    var requestData = { projectName: txtProjectName.val(), projectId: hdnProjectID.val(), projectCode: txtProjectCode.val(), customerId: hdnCustomerId.val(), customerName: txtCustomerName.val(), customerBranch: ddlCustomerBranch.val(), projectStatus: ddlStatus.val()};
    $.ajax({
