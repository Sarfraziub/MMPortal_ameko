...
function GenerateReportParameters() {
    ...
    var url = "../SaleInvoiceSummary/GenerateSaleInvoiceSummaryReports?customerId=" + $("#hdnCustomerId").val() + "&userId=" + $("#hdnCreatedId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    var url = "../SaleInvoiceSummary/GenerateSaleInvoiceSummaryReports?customerId=" + $("#hdnCustomerId").val() + "&userId=" + $("#hdnCreatedId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=Excel";
