...
function GenerateReportParameters() {
    ...
    var url = "../StoreRequisition/GetApprovedPOsMRNNotDone?fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&customerId=" + $("#hdnCustomerId").val() + "&customerBranchId=" + $("#ddlCustomerBranch").val() + "&approvalStatus=0&reportType=PDF";
