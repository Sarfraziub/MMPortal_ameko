...
function SaveData() {
    ...
    $.ajax({
        url: "../EmployeeLeaveDetail/AddEditEmployeeLeaveDetail?AccessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
               ...
               ClearFields();
                setTimeout(
                   function () {
                       window.location.href = "../EmployeeLeaveDetail/AddEditEmployeeLeaveDetail?employeeLeaveId=" + data.trnId + "&AccessMode=3";
                   }, 2000);
...
function ResetPage() {
    if (confirm("Are you sure to reset all fields?")) {
        window.location.href = "../EmployeeLeaveDetail/AddEditEmployeeLeaveDetail?accessMode=1";
    }
}