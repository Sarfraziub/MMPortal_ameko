...
function SaveData() {
    ...
    $.ajax({
        url: "../EmployeeLoanApplication/ApproveRejectEmployeeLoanApplication",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../EmployeeLoanApplication/ApproveRejectEmployeeLoanApplication?applicationId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
