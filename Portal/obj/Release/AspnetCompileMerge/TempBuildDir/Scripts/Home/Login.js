    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status=="SUCCESS")
            {
                ...
                else if (parseInt(data.RoleId) == 75)
                {
                    window.location.href = "../MasterDashboard/MDDashboard";
                }
                else if (parseInt(data.RoleId) == 74) {
                    
                    window.location.href = "../SupervisorDashboard/SupervisorDashboard";
                }
                else if (parseInt(data.RoleId) == 1077) {
                    window.location.href = "../SupervisorDashboard/SupervisorDashboard";
                }
                else if (parseInt(data.RoleId) == 12) {
                    window.location.href = "../Dashboard/PurchaseDashboard";
                }
                else
                {
