...
function GenerateReportParameters() {
    ...
    var url = "../JournalVoucher/GenerateJournalVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../JournalVoucher/GenerateJournalVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=Excel";
