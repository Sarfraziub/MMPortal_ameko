...
function SaveData() {
    ...
    $.ajax({
        url: "../PMS_EmployeeAppraisalReview/AddEditEmployeeAppraisalReview",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../PMS_EmployeeAppraisalReview/AddEditEmployeeAppraisalReview?pMSReviewId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
