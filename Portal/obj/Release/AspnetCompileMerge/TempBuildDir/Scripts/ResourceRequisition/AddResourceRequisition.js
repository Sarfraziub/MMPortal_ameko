...
function SaveData() {
    ...
    $.ajax({
        url: "../ResourceRequisition/AddEditResourceRequisition",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../ResourceRequisition/AddEditResourceRequisition?resourcerequisitionId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
