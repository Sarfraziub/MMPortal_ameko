$(document).ready(function () {
    ...
    $("#txtSiteChallanNo").attr('readOnly', true);
    $("#txtSiteChallanDate").attr('readOnly', true);
    ...
    $("#txtCustomerName").autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                url: "../SiteDeliveryChallan/GetCustomerAutoCompleteList",
                type: "GET",
                dataType: "json",
...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    $("#txtProductTaxName").autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                url: "../SiteDeliveryChallan/GetTaxAutoCompleteList",
                type: "GET",
                dataType: "json",
                data: { term: request.term },
                success: function (data) {
...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    var hdnSiteChallanId = $("#hdnSiteChallanId");
    if (hdnSiteChallanId.val() != "" && hdnSiteChallanId.val() != "0" && hdnAccessMode.val() != "" && hdnAccessMode.val() != "0") {
        setTimeout(
       function () {
           GetSiteChallanDetail(hdnSiteChallanId.val());
       }, 3000);
    ...
    var siteChallanProducts = [];
    GetSiteChallanProductList(siteChallanProducts);
    var siteChallanTaxes = [];
    GetChallanTaxList(siteChallanTaxes);
    var siteChallanTerms = [];
    GetSiteChallanTermList(siteChallanTerms);
    var siteDeliveryChallanDocuments = [];
    GetSiteDeliveryChallanDocumentList(siteDeliveryChallanDocuments);
...
function BindCountryList(countryId) {
    $.ajax({
        type: "GET",
...
function BindStateList(countriesId,stateId) {
    var countryId = "";
    if(countriesId != undefined && countriesId != "" && countriesId != "0")
    {
        countryId = countriesId;
    }
    else
    {
        countryId = $("#ddlSCountry option:selected").val();
    }        
    $("#ddlSState").val(0);
    $("#ddlSState").html("");
...
function GetBranchStateId() {
    ...
    $.ajax({
        type: "GET",
        url: "../SiteDeliveryChallan/GetCompanyBranchByStateIdList",
...
function BindTermTemplateList() {
    $.ajax({
        type: "GET",
        url: "../SiteDeliveryChallan/GetTermTemplateList",
        data: "{}",
        dataType: "json",
        asnc: false,
        success: function (data) {
...
function GetSiteDeliveryChallanDocumentList(siteDeliveryChallanDocuments) {
    var hdnSiteChallanId = $("#hdnSiteChallanId");
    var requestData = { siteDeliveryChallanDocuments: siteDeliveryChallanDocuments, siteChallanId: hdnSiteChallanId.val() };
    $.ajax({
        url: "../SiteDeliveryChallan/GetSiteDeliveryChallanSupportingDocumentList",
        cache: false,
...
function SaveDocument() {
    ...
    $.ajax({
        url: "../SiteDeliveryChallan/SaveSupportingDocument",
        type: "POST",
        asnc: false,
        ...
        success: function (result) {
            if (result.status == "SUCCESS") {
                ...
                var hdnSiteDeliveryChallanDocId = $("#hdnSiteDeliveryChallanDocId");
                ...
                $('#tblDocumentList tr').each(function (i, row) {
                    ...
                    var hdnSiteDeliveryChallanDocId = $row.find("#hdnSiteDeliveryChallanDocId").val();
                    ...
                    if (hdnSiteDeliveryChallanDocId != undefined) {
                        if ((hdnDocumentSequence.val() != documentSequenceNo)) {

                            var siteDeliveryChallanDocument = {
                                SiteDeliveryChallanDocId: hdnSiteDeliveryChallanDocId,
                            ...
                            siteDeliveryChallanDocuments.push(siteDeliveryChallanDocument);
                            docEntrySequence = parseInt(docEntrySequence) + 1;
                        }
                        else if (hdnSiteDeliveryChallanDocId.val() == siteDeliveryChallanDocId && hdnDocumentSequence.val() == documentSequenceNo) {
                            var siteDeliveryChallanDocument = {
                                SiteDeliveryChallanDocId: hdnSiteDeliveryChallanDocId.val(),
                            ...
                            deliverySiteChallanDocuments.push(deliverySiteChallanDocument);
                        }
                    }
                });
                if ((hdnDocumentSequence.val() == "" || hdnDocumentSequence.val() == "0")) {
                ...
                var siteDeliveryChallanDocumentAddEdit = {
                    SiteDeliveryChallanDocId: hdnSiteDeliveryChallanDocId.val(),
                    DocumentSequenceNo: hdnDocumentSequence.val(),
                    DocumentTypeId: ddlDocumentType.val(),
                    DocumentTypeDesc: $("#ddlDocumentType option:selected").text(),
                ...
                siteDeliveryChallanDocuments.push(siteDeliveryChallanDocumentAddEdit);
...
function ShowHideDocumentPanel(action) {
    if (action == 1) {
        ...
        $("#hdnSiteDeliveryChallanDocId").val("0");
        $("#FileUpload1").val("");
...
function BindTermsDescription() {
    ...
    if (termTemplateId != undefined && termTemplateId != "" && termTemplateId != "0") {
        ...
        $.ajax({
            type: "GET",
            url: "../SiteDeliveryChallan/GetTermTemplateDetailList",
            data: data,
            asnc: false,
            dataType: "json",
            success: function (data) {
                ...
                $.each(data, function (i, item) {
                    var sitechallanTerm = {
                        SiteChallanTermDetailId: item.TrnId,
                ...
                GetSiteChallanTermList(siteChallanTermList);
            },
            error: function (Result) {
                GetSiteChallanTermList(siteChallanTermList);
            }
...
function GetSiteChallanTermList(siteChallanTerms) {
    var hdnSiteChallanId = $("#hdnSiteChallanId");
    var requestData = { siteChallanTerms: siteChallanTerms, siteChallanId: hdnSiteChallanId.val() };
    $.ajax({
        url: "../SiteDeliveryChallan/GetSiteChallanTermList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function AddTerm(action) {
    ...
    var hdnSiteChallanTermDetailId = $("#hdnSiteChallanTermDetailId");
    ...
    $('#tblTermList tr').each(function (i, row) {
        ...
        if (termDesc != undefined) {
            if (action == 1 || hdnSiteChallanTermDetailId.val() != siteChallanTermDetailId) {
    ...
    if (hdnTermSequence.val() == "" || hdnTermSequence.val() == "0") {
     ...
     var siteChallanTermAddEdit = {
        SiteChallanTermDetailId: hdnSiteChallanTermDetailId.val(),
        TermDesc: txtTermDesc.val().trim(),
        TermSequence: hdnTermSequence.val()
    };

    siteChallanTermList.push(siteChallanTermAddEdit);
    GetSiteChallanTermList(siteChallanTermList);
...
function EditTermRow(obj) {
    ...
    $("#hdnSiteChallanTermDetailId").val(siteChallanTermDetailId);
...
function AddProduct(action) {
    ...
    var hdnSiteChallanProductDetailId = $("#hdnSiteChallanProductDetailId");
    ...
    $('#tblProductList tr').each(function (i, row) {
        ...
        var siteChallanProductDetailId = $row.find("#hdnSiteChallanProductDetailId").val();
        ...
        if (productName != undefined) {
            if (action == 1 || (hdnSequenceNo.val() != sequenceNo)) {
                ...
                var siteChallanProduct = {
                    SiteChallanProductDetailId: hdnSiteChallanProductDetailId.val(),
    ...
    if (action == 1) {
        ...
        siteChallanProductList.push(siteChallanProductAddEdit);
        hdnSequenceNo.val("0");
    }
    GetSiteChallanProductList(siteChallanProductList);

}
function GetSiteChallanProductList(siteChallanProducts) {
    var hdnSiteChallanId = $("#hdnSiteChallanId");
    var requestData = { siteChallanProducts: siteChallanProducts, siteChallanId: hdnSiteChallanId.val() };
    $.ajax({
        url: "../SiteDeliveryChallan/GetSiteChallanProductList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function EditProductRow(obj) {
    ...
    $("#hdnSiteChallanProductDetailId").val(siteChallanProductDetailId);
...
function GetSiteChallanDetail(siteChallanId) {
    $.ajax({
        type: "GET",
        asnc: false,
        url: "../SiteDeliveryChallan/GetSiteChallanDetail",
        data: { siteChallanId: siteChallanId },
        dataType: "json",
        success: function (data) {
            $("#txtSiteChallanNo").val(data.SiteChallanNo);
            $("#txtSiteChallanDate").val(data.SiteChallanDate);
            $("#txtInvoiceNo").val(data.InvoiceNo);
            $("#hdnInvoiceId").val(data.InvoiceId);
            $("#txtInvoiceDate").val(data.InvoiceDate);
            $("#txtSINNo").val(data.SinNo);
            $("#hdnSinId").val(data.SinId);
            ...
            BindStateList(data.ShippingCountryId, data.ShippingStateId);
...
function SaveData() {
    var txtSiteChallanNo = $("#txtSiteChallanNo");
    var hdnSiteChallanId = $("#hdnSiteChallanId");
    var txtSiteChallanDate = $("#txtSiteChallanDate");
    ...
    if (ddlSCountry.val() == "" || ddlSCountry.val() == "0") {
        ShowModel("Alert", "Please select Country")
        return false;
    }

    if (ddlSState.val() == "" || ddlSState.val() == "0") {
    ...
    var siteChallanViewModel = {
        SiteChallanId: hdnSiteChallanId.val(),
        SiteChallanNo: txtSiteChallanNo.val().trim(),
        SiteChallanDate: txtSiteChallanDate.val().trim(),
        InvoiceId: hdnInvoiceId.val().trim(),
        InvoiceNo: txtInvoiceNo.val().trim(),
        SinId: hdnSinId.val().trim(),
        SinNo: txtSinNo.val(),
        ...
        CustomerBranchId: ddlSCustomerBranch.val()
    };
    ...
    if (hdnSiteChallanId.val() != null && hdnSiteChallanId.val() != 0) {
    ...
    $.ajax({
        url: "../SiteDeliveryChallan/AddEditSiteDeliveryChallan?AccessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../SiteDeliveryChallan/AddEditSiteDeliveryChallan?SiteChallanId=" + data.trnId + "&AccessMode=3";
                   }, 2000);
...
function ClearFields() {
    ...
    $("#txtSiteChallanNo").val("");
    $("#hdnSiteChallanId").val("0");
    $("#txtSiteChallanDate").val($("#hdnCurrentDate").val());
    $("#hdnCustomerId").val("0");
    $("#txtCustomerName").val("");
    $("#txtCustomerCode").val("");
    $("#hdnConsigneeId").val("0");
...
function ShowHideProductPanel(action) {
    if (action == 1) {
        ...
        $("#txtProductName").val("");
        $("#hdnProductId").val("0");
        $("#hdnSiteChallanProductDetailId").val("0");
        $("#txtProductCode").val("");
        $("#txtProductShortDesc").val("");
        $("#txtPrice").val("");
...
function ShowHideTermPanel(action) {
    if (action == 1) {
        ...
        $(".termsection").hide();
        $("#txtTermDesc").val("");
        $("#hdnSiteChallanTermDetailId").val("0");
...
function OpenSinSearchPopup() {
    $("#SearchSinModel").modal();
...
/*Sin Section Popup*/
function SearchSIN() {
    var txtSearchSINNo = $("#txtSearchSINNo");
   ...
   // var ddlSINStatus = $("#ddlSINStatus");
    var requestData = { sinNo: txtSearchSINNo.val(), requisitionNo: $("#txtRequisitionNo").val(), jobno: '', companyBranchId: '', fromDate: txtFromDate.val(), toDate: txtToDate.val(), sINStatus: '' };
    $.ajax({
        url: "../SiteDeliveryChallan/GetSINList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
//    var requestData = { sinNo: txtSinNo.val().trim(), requisitionNo: txtRequisitionNo.val().trim(), fromDate: txtFromDate.val(), toDate: txtToDate.val(),  displayType: "Popup", approvalStatus: "Final" };
//    $.ajax({
//        url: "../SiteDeliveryChallan/GetSinList",
//        data: requestData,
//        dataType: "html",
...
//    });
//}
function SelectSin(sinId, sinNo, sinDate, BranchAddress, CustomerId, CustomerName, CustomerCode, BranchName, CustomerBranchId, CustomerBranchName, CompanyBranchId, CountryId, StateId, City, CustomerAddress, CustomerGSTNo, CustomerBranchAddress, CustomerBranchGSTNo) {
    $("#txtSINNo").val(sinNo);
    $("#hdnSinId").val(sinId);
    $("#txtSinDate").val(sinDate);
    $("#hdnCustomerId").val(CustomerId);
    $("#txtCustomerCode").val(CustomerCode);
    $("#txtCustomerName").val(CustomerName);
    ...
    if (CustomerBranchAddress != "") {
        $("#txtSAddress").val(CustomerBranchAddress);
    }
    else {
        $("#txtSAddress").val(CustomerAddress);
    }
    if (CustomerBranchGSTNo != "") {
        $("#txtSGSTNo").val(CustomerBranchGSTNo);
    }
    else {
        $("#txtSGSTNo").val(CustomerGSTNo);
    }
    $("#hdnBillingStateId").val(CompanyBranchId);
    GetCustomerBranchListByID(CustomerId, CustomerBranchId);
    BindCompanyBranchList(CompanyBranchId);
    BindCountryList(CountryId);
    BindStateList(CountryId,StateId);
    $("#txtSCity").val(City);
    $("#SearchSinModel").modal('hide');
 //   GetConsigneeDetail(consigneeId);
  //  GetSinDetail(sinId);
    var sinProducts = [];
    GetSinProductList(sinProducts, sinId);
    //var saleinvoiceTaxes = [];
   // GetSaleInvoiceTaxList(saleinvoiceTaxes, invoiceId);
   // var saleinvoiceTerms = [];
   // GetSaleInvoiceTermList(saleinvoiceTerms, invoiceId);
...
function GetSinProductList(sinProducts ,sinId) {
    var hdnsinId = sinId; // $("#hdnsINId");
    var requestData = { sinProducts: sinProducts, sinId: hdnsinId };
    $.ajax({
        url: "../SiteDeliveryChallan/GetSINProductList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function GetCustomerBranchListByID(customerId, customerBranchId) {
    $.ajax({
        ...
        success: function (data) {
           ...
           // $("#ddlSCustomerBranch").append($("<option></option>").val(0).html("-Select Customer Branch-"));
            $.each(data, function (i, item) {
...
function ResetPage() {
    if (confirm("Are you sure to reset all fields?")) {
        window.location.href = "../SiteDeliveryChallan/AddEditSiteDeliveryChallan?accessMode=1";
    }
}