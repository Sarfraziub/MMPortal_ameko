...
function BindCompanyBranchList() {
    ...
    $.ajax({
        ...
        asnc: false,
        success: function (data) {
            $("#ddlCompanyBranch,#ddlSearchCompanyBranch").append($("<option></option>").val(0).html("-Select Branch-"));
...
function EditProductRow(obj) {
    ...
    $("#hdnProductMainGroupId").val(productMainGroupId);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.ApprovalStatus != "") {
                $("#divApprovelStatus").show();
                $("#txtApprovelStatus").val(data.ApprovalStatus);
            }
...
function ResetPage()
{
    ...
    {
        window.location.href = "../StoreRequisition/AddEditStoreRequisition?accessMode=1";
    }
}
