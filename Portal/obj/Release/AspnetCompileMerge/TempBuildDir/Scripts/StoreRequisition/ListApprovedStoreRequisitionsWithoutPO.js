...
function GenerateReportParameters() {
    ...
    var url = "../StoreRequisition/GetApprovedStoreRequisitionsWithoutPO?requisitionNo=" + $("#txtRequisitionNo").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&customerId=" + $("#hdnCustomerId").val() + "&customerBranchId=" + $("#ddlCustomerBranch").val() + "&approvalStatus=0&displayType=&reportType=PDF";
...
$('body').on('change', '#txtCustomerName', function () {
    GenerateReportParameters();
});
