...
function SaveData() {
    ...
    $.ajax({
        url: "../EmployeeClearanceProcess/AddEditEmployeeClearanceProcess",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../EmployeeClearanceProcess/AddEditEmployeeClearanceProcess?employeeClearanceId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
