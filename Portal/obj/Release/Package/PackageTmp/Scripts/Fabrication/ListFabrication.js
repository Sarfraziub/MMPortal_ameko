...
function SearchFabrication() {
    ...
    var requestData = { fabricationNo: txtFabricationNo.val(), workOrderNo: txtWorkOrderNo.val().trim(), companyBranchId: ddlCompanyBranch.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), fabricationStatus: ddlApprovalStatus.val() };
    $.ajax({
