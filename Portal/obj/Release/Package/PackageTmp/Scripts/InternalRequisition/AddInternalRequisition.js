...
function SaveData() {
    ...
    var storeRequisitionProductList = [];
        ...
        $.ajax({
            url: "../InternalRequisition/AddEditInternalRequisition",
            cache: false,
            type: "POST",
            dataType: "json",
            data: JSON.stringify(requestData),
            ...
            success: function (data) {
                if (data.status == "SUCCESS") {
                    ...
                    setTimeout(
                       function () {
                           window.location.href = "../InternalRequisition/AddEditInternalRequisition?internalRequisitionId=" + data.trnId + "&AccessMode=2";
                       }, 1000);
