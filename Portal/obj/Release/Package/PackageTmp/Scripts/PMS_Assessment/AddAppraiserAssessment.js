...
function SaveData() {
    ...
    $.ajax({
        url: "../PMS_Assessment/AddEditAppraiserAssessment",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../PMS_Assessment/AddEditAppraiserAssessment?empAppraisalTemplateMappingId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
