...
function SaveData() {
    ...
    $.ajax({
        url: "../PMS_Assessment/AddEditEmployeeSelfAssessment",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../PMS_Assessment/AddEditEmployeeSelfAssessment?empAppraisalTemplateMappingId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
