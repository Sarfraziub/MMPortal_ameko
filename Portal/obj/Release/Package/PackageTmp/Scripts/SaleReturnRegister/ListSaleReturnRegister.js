...
function SearchSaleReturnRegister() {
    ...
    var requestData = { saleReturnNo: txtSaleReturnNo.val().trim(), customerName: txtCustomerName.val().trim(), dispatchrefNo: txtDispatchRefNo.val().trim(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), approvalStatus: ddlApprovalStatus.val(), sortBy: ddlSortBy.val(), SortOrder: ddlSortOrder.val() };
    $.ajax({
