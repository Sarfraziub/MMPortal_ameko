...
function GenerateReportParameters() {
    ...
    var url = "../StoreRequisition/GetApprovedPOsCustomerSiteMRNNotDone?fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&customerId=" + $("#hdnCustomerId").val() + "&customerBranchId=" + $("#ddlCustomerBranch").val() + "&approvalStatus=0&reportType=PDF";
