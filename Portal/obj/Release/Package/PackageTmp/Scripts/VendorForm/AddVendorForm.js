...
function SaveData() {    
    ...
    if (hdnVendorFormTrnId.val() != null && hdnVendorFormTrnId.val() != 0) {
        accessMode = 2;//Edit Mode
    }
    var requestData = { vendorFormViewModel: vendorformViewModel };
    $.ajax({
        url: "../VendorForm/AddEditVendorForm?AccessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../VendorForm/AddEditVendorForm?AccessMode=1";
                   }, 3000);
