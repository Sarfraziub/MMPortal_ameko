...
function GenerateReportParameters() {
    ...
    var url = "../Voucher/GenerateBankVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../Voucher/GenerateBankVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=Excel";
